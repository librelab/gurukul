...
${\color{blue}Date: \space \color{green}30 \ July \ 2026}$<br>
...
<img width="400" height="364" alt="github-uow-400" src="https://github.com/user-attachments/assets/33fe3674-1c3f-44e8-820c-4423a7e5c721" />
...
ST1-1WS-S<br>
------------
1. **observes, questions and collects data to communicate and compare ideas**

#### Activity:
 Rishaan participated in scientific investigations by observing everyday phenomena as well as carrying out experiments, asking questions, making predictions, collecting information, recording results, and sharing findings. Activities included plant growth observations, weather recording, simple experiments, and investigations using household materials.
 
#### Example:
 During chemistry Experiment, Rishaan observed that the bubbles created where bigger when compared to first experiment because of the additional ingredient "soap". He read the instructions and added exact amount of quantity in the Baking soda to create the bigger bubble. Noted down the apparatus used and explained what is formed when its mixed. 
 
#### Observation:
 The student demonstrates curiosity and actively engages in scientific investigations. He makes observations, asks relevant questions, collects and records simple data, and communicates his findings through drawings, tables, discussions, and written explanations. He compares results and reflects on what he has learned.
...
ST1-2DP-T<br>
-------------
2. **uses materials, tools and equipment to develop solutions for a need or opportunity**

#### Activity:	
 The student participated in design and technology activities where he identified simple needs or problems and created solutions using different materials, tools, and equipment. Activities included building structures with LEGO, designing simple models, creating storage solutions, and testing his designs.
 
#### Example:
 Rishaan at the time to fix screw on drywall, will get the stud finder to have strong backsupport for the screw which he understands. It also makes us of the laser distance measuring device to measure the length of the room. He easily assembles desktop shelf by reading the instructions and using the tools given or get the tools like Allen key, screwdriver to get the task done
 
#### Observation:	
 The student demonstrates creativity and problem-solving skills when designing and making solutions. He selects appropriate materials and tools, follows safety practices, and evaluates his creations. He explains his design choices and makes changes to improve the effectiveness of his solutions.
...
ST1-3DP-T<br>
-------------
3. **describes, follows and represents algorithm to solve problems**

#### Activity:	
 The student explored algorithms/instructions through activities, electrical/electronic tasks, sequencing games, and everyday problem-solving activities. He practised creating and following step-by-step instructions, identifying patterns.
 
#### Example:
 During electrical snap on circuit activity, Rishaan created different circuits with different loads like LED, motor, Speaker. This he tested out with and without switch which could be a press button or a toggle switch. In case of non working scenario he would improvise. He would read instructions given to create complex circuits.  
 
#### Observation:	
 The student demonstrates an understanding that algorithms are step-by-step instructions used to solve problems. He can describe, follow, and represent simple algorithms and identifies the importance of clear sequencing. He shows persistence when testing solutions and makes changes to improve outcomes.
